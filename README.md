# Run Mocha Tests With Custom Test Name on TestMu AI (Formerly LambdaTest)
...
To set test name for automation test in Mocha-js on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)), the following steps can be followed. You can refer to the sample test repo [here](https://github.com/LambdaTest/Mocha-selenium-sample).
